...
pre_survey <- sapply(list.files('data', 'pre_workshop', full.names = TRUE), read_csv) %>% bind_cols()
post_survey <- sapply(list.files('data', 'post_workshop', full.names = TRUE), read_csv) %>% bind_cols()
```
