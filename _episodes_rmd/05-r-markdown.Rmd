...
Before writing the report, let's take a quick detour and learn just a bit about Markdown first. 
Mardown is a way that you can use plain text to tell the program that renders the file to change the way text looks, making it "rich text".
TODO: Decide exactly what to teach - maybe keep rest here for reference?
