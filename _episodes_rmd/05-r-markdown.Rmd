...
What country had the highest life expectancy in 1982?

```{r,comment=NA,echo=F,collapse=T}
gap1982 <- filter(gapminder, year==1982)
gap1982 %>% slice_max(lifeExp)
```

Make a boxplot for the life expectancies of the countries in each continent

```{r,comment=NA,echo=F,collapse=T}
ggplot(gapminder,aes(x=continent,y=lifeExp)) + geom_boxplot()
```

Challenge question: Which country has had the greatest increase in life expectancy from 1952 to 2007?
...
TODO: check with R analysis team for the CO2 data format after that part of workshop
