...
TODO: *check format of code in exercises* 
First we're going to start out with a few questions about the gapminder dataset.

1. The very first step is to read in the gapminder dataset, so do don't forget that step! Also load the `tidyverse` package.
