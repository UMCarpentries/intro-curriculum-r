...
#### Plotting with the new, gapminder and CO2 datasets together

1. First, merge the dataframes by country.
...
6. (Open-ended questions)
   ...
   3. Create an R Markdown report with all of the information you found from these exercises. 
